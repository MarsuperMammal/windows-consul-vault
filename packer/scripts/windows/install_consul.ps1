...
netsh advfirewall firewall add rule name="Consul Sever TCP" dir=in action=allow protocol=TCP localport=8300
...
netsh advfirewall firewall add rule name="Consul RPC TCP" dir=in action=allow protocol=TCP localport=8400
netsh advfirewall firewall add rule name="Consul HTTP TCP" dir=in action=allow protocol=TCP localport=8500
netsh advfirewall firewall add rule name="Consul DNS TCP" dir=in action=allow protocol=TCP localport=8600
